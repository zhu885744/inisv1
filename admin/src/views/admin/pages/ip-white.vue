            ...
            <el-col :span="24">
                <el-tabs v-model="state.item.tabs" v-on:tab-change="method.change" id="tabs-area">
                    ...
                    <el-tab-pane name="all">
                        ...
                        <table-ip-white :params="state.params.all" v-model:init="state.tabs.all" v-on:refresh="method.refresh" ref="all"></table-ip-white>
                    </el-tab-pane>
                    ...
                    <el-tab-pane name="remove">
                        ...
                        <table-ip-white :params="state.params.remove" v-model:init="state.tabs.remove" v-on:refresh="method.refresh" ref="remove" type="remove"></table-ip-white>
                    </el-tab-pane>
...
import TableIpWhite from '{src}/comps/admin/table/ip-white.vue'
