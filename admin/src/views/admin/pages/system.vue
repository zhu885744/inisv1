                ...
                <el-tabs v-model="state.item.tabs" id="tabs-area">
                    ...
                    <el-tab-pane name="other">
                        ...
                        <el-row :gutter="20" style="margin-top: 12px">
                            ...
                            <el-col :span="8">
                                <atom-integral-rules ref="integral-rules" v-on:refresh="method.refresh"></atom-integral-rules>
                            </el-col>
                            <el-col :span="8">
...
const state  = reactive({
    ...
    refresh: {
        ...
        other   : ['page','article','comment','exp-rules','integral-rules','notification'],
