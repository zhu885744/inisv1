...
// IGET - GET请求本体
func (this *AlbumGroup) IGET(ctx *gin.Context) {
	// 转小写
...
// IPOST - POST请求本体
func (this *AlbumGroup) IPOST(ctx *gin.Context) {
...
// IPUT - PUT请求本体
func (this *AlbumGroup) IPUT(ctx *gin.Context) {
	// 转小写
	method := strings.ToLower(ctx.Param("method"))
...
// IDEL - DELETE请求本体
func (this *AlbumGroup) IDEL(ctx *gin.Context) {
	// 转小写
	method := strings.ToLower(ctx.Param("method"))
...
// INDEX - GET请求本体
func (this *AlbumGroup) INDEX(ctx *gin.Context) {
	this.json(ctx, nil, facade.Lang(ctx, "没什么用！"), 202)
}

// 删除缓存
func (this *AlbumGroup) delCache() {
	// 删除缓存
	facade.Cache.DelTags([]any{"[GET]","album-group"})
}

// one 获取指定数据
func (this *AlbumGroup) one(ctx *gin.Context) {
...
// all 获取全部数据
func (this *AlbumGroup) all(ctx *gin.Context) {
...
// rand 随机获取
func (this *AlbumGroup) rand(ctx *gin.Context) {
	...
	item := facade.DB.Model(&model.AlbumGroup{}).OnlyTrashed(onlyTrashed).WithTrashed(withTrashed)
	...
	// 查询条件
	mold := facade.DB.Model(&[]model.AlbumGroup{}).Where("id", "IN", ids).WithoutField("content")
...
// save 保存数据 - 包含创建和更新
func (this *AlbumGroup) save(ctx *gin.Context) {
...
// create 创建数据
func (this *AlbumGroup) create(ctx *gin.Context) {

	// 获取请求参数
	params := this.params(ctx)
	// 验证器
	err := validator.NewValid("album-group", params)
	...
	// 表数据结构体
	table := model.AlbumGroup{Uid: uid, CreateTime: time.Now().Unix(), UpdateTime: time.Now().Unix()}
	allow := []any{"name", "description", "covers", "remark", "json", "text"}
...
// update 更新数据
func (this *AlbumGroup) update(ctx *gin.Context) {
...
// count 统计数据
func (this *AlbumGroup) count(ctx *gin.Context) {
...
// sum 求和
func (this *AlbumGroup) sum(ctx *gin.Context) {
...
// min 求最小值
func (this *AlbumGroup) min(ctx *gin.Context) {
...
// max 求最大值
func (this *AlbumGroup) max(ctx *gin.Context) {
...
// column 获取单列数据
func (this *AlbumGroup) column(ctx *gin.Context) {
...
// remove 软删除
func (this *AlbumGroup) remove(ctx *gin.Context) {
...
// delete 真实删除
func (this *AlbumGroup) delete(ctx *gin.Context) {
...
// clear 清空回收站
func (this *AlbumGroup) clear(ctx *gin.Context) {
...
// restore 恢复数据
func (this *AlbumGroup) restore(ctx *gin.Context) {
