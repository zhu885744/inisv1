...
// IGET - GET请求本体
func (this *Album) IGET(ctx *gin.Context) {
	// 转小写
...
// IPOST - POST请求本体
func (this *Album) IPOST(ctx *gin.Context) {
...
// IPUT - PUT请求本体
func (this *Album) IPUT(ctx *gin.Context) {
	// 转小写
	method := strings.ToLower(ctx.Param("method"))
...
// IDEL - DELETE请求本体
func (this *Album) IDEL(ctx *gin.Context) {
	// 转小写
	method := strings.ToLower(ctx.Param("method"))
...
// INDEX - GET请求本体
func (this *Album) INDEX(ctx *gin.Context) {
	this.json(ctx, nil, facade.Lang(ctx, "没什么用！"), 202)
}

// 删除缓存
func (this *Album) delCache() {
	// 删除缓存
	facade.Cache.DelTags([]any{"[GET]","album"})
}

// one 获取指定数据
func (this *Album) one(ctx *gin.Context) {
...
// all 获取全部数据
func (this *Album) all(ctx *gin.Context) {
...
// rand 随机获取
func (this *Album) rand(ctx *gin.Context) {
	...
	item := facade.DB.Model(&model.Album{}).OnlyTrashed(onlyTrashed).WithTrashed(withTrashed)
	...
	// 查询条件
	mold := facade.DB.Model(&[]model.Album{}).Where("id", "IN", ids).WithoutField("content")
...
// save 保存数据 - 包含创建和更新
func (this *Album) save(ctx *gin.Context) {
...
// create 创建数据
func (this *Album) create(ctx *gin.Context) {

	// 获取请求参数
	params := this.params(ctx)
	// 验证器
	err := validator.NewValid("album", params)
	...
	// 分组不能为空
	if cast.ToInt(params["group"]) == 0 {
		this.json(ctx, nil, facade.Lang(ctx, "%s 不能为空！", "group"), 400)
		return
	}
	...
	// 表数据结构体
	table := model.Album{Uid: uid, CreateTime: time.Now().Unix(), UpdateTime: time.Now().Unix()}
	allow := []any{"title", "content", "image", "tags", "group", "remark", "json", "text"}
...
// update 更新数据
func (this *Album) update(ctx *gin.Context) {
...
// count 统计数据
func (this *Album) count(ctx *gin.Context) {
...
// sum 求和
func (this *Album) sum(ctx *gin.Context) {
...
// min 求最小值
func (this *Album) min(ctx *gin.Context) {
...
// max 求最大值
func (this *Album) max(ctx *gin.Context) {
...
// column 获取单列数据
func (this *Album) column(ctx *gin.Context) {
...
// remove 软删除
func (this *Album) remove(ctx *gin.Context) {
...
// delete 真实删除
func (this *Album) delete(ctx *gin.Context) {
...
// clear 清空回收站
func (this *Album) clear(ctx *gin.Context) {
...
// restore 恢复数据
func (this *Album) restore(ctx *gin.Context) {
...
// 更新文章浏览量
func (this *Album) updateViews(data map[string]any) {
	facade.DB.Model(&model.Album{}).Where("id", data["id"]).Inc("views", 1)
}

// 清理垃圾
func (this *Album) rubbish(ids []any) {

	// 删除评论
	go facade.DB.Model(&[]model.Comment{}).WithTrashed().Force().WhereIn("bind_id", ids).Where("bind_type", "album").Delete()
}